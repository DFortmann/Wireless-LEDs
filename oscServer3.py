...
""" 
Load the three different videos at startup.
The video data is packed as arrays of bytes in a txt file, one line per frame.
"""
...
""" 
	...
	They convert the 'timecode' from the the range 0-1 to the numbers of frames a file.
	When the frame number wasn't received before, they read the corresponding line form the file.
